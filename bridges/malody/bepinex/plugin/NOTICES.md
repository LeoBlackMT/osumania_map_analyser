...
历史值：T1 为 50,688 字节 / SHA256 `DB9DAA598FF629390618311CE6CB9272C591E54E4BDC59468318458268A2DD57`（8 字段）；T2 为 71,168 字节 / `C3DD44165C5ECA19B041E93F27C2D4237F4A439E030294C28412ACDD977BF438`（11 字段）。**T2b 实测：72,704 字节**，SHA256 `800DCDE39335DBB697F29E5C381F4C43CD40709D50382375E237230DEC5C8C99`（连续两次构建同值）。（同一 SDK、同一绝对路径下应一致；换 SDK、换路径或只改源文件行尾都可能改变产物哈希。）
