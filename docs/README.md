...
| [features/presets.md](features/presets.md) | AI | 预设系统功能文档（系统/自定义预设、Auto 跟随、快照 schema、echo 防护） |
...
| [features/presets.md](features/presets.md) | AI | Preset system document (system/custom presets, Auto follow mode, snapshot schema, echo guard) |
