...
| [converters.md](converters.md) | AI | 谱面转换器（sm/ssc/mc → osu）：时间轴烘焙语义、键数推导、测试与 golden 摘要 |
...
| [converters.md](converters.md) | AI | Chart converters (sm/ssc/mc → osu): timing baking semantics, key-count derivation, tests and golden summary |
