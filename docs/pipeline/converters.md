...
- `js/app/sources/odResolver.js` — Malody V（游戏内选曲桥）判定档 × Pro（严格/常态组）× 当局倍率 → 等效 osu!mania OD；表值与复算工装见 [../features/malody4-od.md](../features/malody4-od.md)（同一套 96% 等精度 σ\* 方法学）与 `tools/malody-v-od-check/verify.py`
